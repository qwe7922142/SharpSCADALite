    ...
    public static class ExtMethods
    {
        ...
        public static bool ModifyItemName(this ITag tag, string name)
        {
            ...
            lock (server.SyncRoot)
            {
                ...
                server.MetaDataList[index] = new TagMetaData(meta.ID, meta.GroupID, name, meta.Address, meta.DataType, meta.Size, meta.Active, meta.Maximum, meta.Minimum, meta.Cycle);
